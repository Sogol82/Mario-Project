...
public class Player extends Entity {
    ...
    public void draw(Graphics2D g2) {
        ...
        if(x < screenX) {
            g2.drawImage(image, x, y, Data.tileSize, Data.tileSize, null);
        } else if(x > Data.maxLevelWidth - Data.screenWidth + screenX) {
            g2.drawImage(image, x - Data.maxLevelWidth + Data.screenWidth, y, Data.tileSize, Data.tileSize, null);
        } else {
            g2.drawImage(image, screenX, y, Data.tileSize, Data.tileSize, null);
        }
